...
public:
	...
	Service(Repository& r, Validator& v) : repository{ r }, validator{ v } {}
	...
	/// <param name="type">apartament type</param>
	/// <param name="area">apartament surface</param>
	Tenant find_apartament(const int& apart, const string type, const int& area) const;
	...
	void clear_notification_list(vector<Tenant>& notification_list) const;

	/// <summary>
	/// adds to notif list an apartament from repo with given number
	/// </summary>
	/// <param name="notification_list"></param>
	void add_apartament_to_notification_list(vector<Tenant>& notification_list, const int& number) const;

	/// <summary>
	/// adds a number of apartaments from the repo to the notif list
	/// </summary>
	/// <param name="notification_list"></param>
	void add_apartaments_randomly(vector<Tenant>& notification_list, int number) const;
	...
	static void export_to_file(vector<Tenant>& notification_list, const string& file);
